...
## Main Features
Sir Alex has access to a few main tools to help you in your quest for a championship:
1. Access to live and current season footballer data, including your current team and scores
2. Memory of your preferences, such as favorite players and teams
3. Guardrails to keep the conversation focused on the GOAL
...
- Periodic news checks for players in your team to proactively update you via WhatsApp
... will keep thinking
